...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.dayforce;
 ...
 */
public class dayforceConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "dayforce test case")
